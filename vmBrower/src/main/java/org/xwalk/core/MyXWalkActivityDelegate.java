...
public class MyXWalkActivityDelegate implements DecompressListener, ActivateListener {
    ...
    public MyXWalkActivityDelegate(Activity activity,
            ...
            mXWalkUpdater = new XWalkUpdater(
                    new XWalkBackgroundUpdateListener() {
                        ...
                        public void onXWalkUpdateCompleted() {
                            XWalkLibraryLoader.startActivate(MyXWalkActivityDelegate.this, mActivity);
                        }
                    },
                    mActivity);
        } else {
    ...
    public void onResume() {
        Log.d(TAG, "Launcher --> mIsInitializing || mIsXWalkReady"+(mIsInitializing || mIsXWalkReady));
